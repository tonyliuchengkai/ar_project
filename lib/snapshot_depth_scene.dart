          ...
          IconButton(
            ...
            onPressed:
                () => Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder:
                        (context) => DepthDataPreview(depthData: depthData),
                  ),
                ),
          ),
        ],
...
class DepthDataPreview extends StatelessWidget {
  const DepthDataPreview({super.key, required this.depthData});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Depth Data Preview')),
      body: ListView(
        children: [
          ListTile(
