...
class _WidgetProjectionPageState extends State<WidgetProjectionPage> {
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: AppBar(title: const Text('Widget Projection')),
    body: Stack(
      children: [
        ARKitSceneView(
        ...
        Positioned(
          ...
          child: Container(
            ...
            width: width,
            height: height,
            child: const MyHomePage(title: 'Widgets in AR'),
          ),
        ),
      ],
    ),
  ...
  Future _updatePosition(ARKitImageAnchor anchor) async {
    ...
    setState(() {
      ...
      this.width = pointsViewportSpaceResults[0]!.distanceTo(
        pointsViewportSpaceResults[3]!,
      );
      this.height = pointsViewportSpaceResults[1]!.distanceTo(
        pointsViewportSpaceResults[2]!,
      );
    });
  }
}
